...
g = {
  ...
  'target_temp': Gauge('nest_thermostat_target_temp', 'Desired temperature', ['structure', 'device']),
  'current_temp': Gauge('nest_thermostat_current_temp', 'Temperature, measured at the device', ['structure', 'device']),
